package org.elSasen.infrastructure.console.state.client;
        ...
        if (authorized) {
            ...
            switch (generalChoose) {
                ...
                case "deb":
                    ...
                    if (transactionService.debit(transactionAmount, authorizationLogin)) {
                ...
                case "cr":
                    ...
                    transactionService.credit(transactionAmount2, authorizationLogin);
                    System.out.println("Thank you!");
                    break;
                case "h":
